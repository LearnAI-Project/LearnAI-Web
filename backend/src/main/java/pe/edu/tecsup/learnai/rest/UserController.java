...
import pe.edu.tecsup.learnai.mapper.UserMapper;
import pe.edu.tecsup.learnai.rest.dto.UserDto;
import pe.edu.tecsup.learnai.security.CustomUserDetails;
import pe.edu.tecsup.learnai.service.UserService;

import java.util.List;
import java.util.stream.Collectors;

import static pe.edu.tecsup.learnai.config.SwaggerConfig.BASIC_AUTH_SECURITY_SCHEME;
